...
class queen:
    def __init__ (self, n, n_primary, threshold=15):
        self.n_queen = n
        self.population_size = n_primary
        self.threshold = threshold
        self.initsolution = self.generateRandomSolution(n_primary)
    ...
    def makeitrain(self):
        ...
        for score in self.fitnessscores:
            if score == self.maximumconflict:
                ...
                db.init(1, 80, self.initsolution[self.fitnessscores.index(score)], self.n_queen)
                break
